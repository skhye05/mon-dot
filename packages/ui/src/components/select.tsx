...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "border-input bg-background data-[placeholder]:text-muted-foreground flex w-fit items-center justify-between gap-1.5 rounded-md border px-2 text-xs whitespace-nowrap shadow-xs transition-[color,box-shadow] outline-none",
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn(
        "text-muted-foreground px-2 py-1.5 text-[0.6875rem] font-medium tracking-wide uppercase",
        className
      )}
      {...props}
    />
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-muted focus:text-foreground relative flex w-full cursor-default items-center gap-2 rounded-sm py-1.5 pr-7 pl-2 text-xs outline-none select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
